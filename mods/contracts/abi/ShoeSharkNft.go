...
// ShoeSharkNft is an auto generated Go binding around an Ethereum contracts.
type ShoeSharkNft struct {
	ShoeSharkNftCaller     // Read-only binding to the contracts
	ShoeSharkNftTransactor // Write-only binding to the contracts
	ShoeSharkNftFilterer   // Log filterer for contracts events
}

// ShoeSharkNftCaller is an auto generated read-only Go binding around an Ethereum contracts.
type ShoeSharkNftCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ShoeSharkNftTransactor is an auto generated write-only Go binding around an Ethereum contracts.
type ShoeSharkNftTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ShoeSharkNftFilterer is an auto generated log filtering Go binding around an Ethereum contracts events.
type ShoeSharkNftFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ShoeSharkNftSession is an auto generated Go binding around an Ethereum contracts,
// with pre-set call and transact options.
type ShoeSharkNftSession struct {
	Contract     *ShoeSharkNft     // Generic contracts binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// ShoeSharkNftCallerSession is an auto generated read-only Go binding around an Ethereum contracts,
// with pre-set call options.
type ShoeSharkNftCallerSession struct {
	Contract *ShoeSharkNftCaller // Generic contracts caller binding to set the session for
	CallOpts bind.CallOpts       // Call options to use throughout this session
}

// ShoeSharkNftTransactorSession is an auto generated write-only Go binding around an Ethereum contracts,
// with pre-set transact options.
type ShoeSharkNftTransactorSession struct {
	Contract     *ShoeSharkNftTransactor // Generic contracts transactor binding to set the session for
	TransactOpts bind.TransactOpts       // Transaction auth options to use throughout this session
}

// ShoeSharkNftRaw is an auto generated low-level Go binding around an Ethereum contracts.
type ShoeSharkNftRaw struct {
	Contract *ShoeSharkNft // Generic contracts binding to access the raw methods on
}

// ShoeSharkNftCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contracts.
type ShoeSharkNftCallerRaw struct {
	Contract *ShoeSharkNftCaller // Generic read-only contracts binding to access the raw methods on
}

// ShoeSharkNftTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contracts.
type ShoeSharkNftTransactorRaw struct {
	Contract *ShoeSharkNftTransactor // Generic write-only contracts binding to access the raw methods on
}

// NewShoeSharkNft creates a new instance of ShoeSharkNft, bound to a specific deployed contracts.
...
// NewShoeSharkNftCaller creates a new read-only instance of ShoeSharkNft, bound to a specific deployed contracts.
...
// NewShoeSharkNftTransactor creates a new write-only instance of ShoeSharkNft, bound to a specific deployed contracts.
...
// NewShoeSharkNftFilterer creates a new log filterer instance of ShoeSharkNft, bound to a specific deployed contracts.
...
// bindShoeSharkNft binds a generic wrapper to an already deployed contracts.
...
// GetApproved is a free data retrieval call binding the contracts method 0x081812fc.
//
...
// GetMetadataUri is a free data retrieval call binding the contracts method 0xa0bd5c40.
//
...
// GetMetadataUriSuffix is a free data retrieval call binding the contracts method 0x52b27860.
//
...
// GetOwner is a free data retrieval call binding the contracts method 0x893d20e8.
//
...
// GetTokenCounter is a free data retrieval call binding the contracts method 0x6e02007d.
//
...
// GetTokenURI is a free data retrieval call binding the contracts method 0x3bb3a24d.
//
...
// OwnerOf is a free data retrieval call binding the contracts method 0x6352211e.
//
...
// SHasMinted is a free data retrieval call binding the contracts method 0x4d82503c.
//
...
// SRoot is a free data retrieval call binding the contracts method 0x92959ffb.
//
...
// SupportsInterface is a free data retrieval call binding the contracts method 0x01ffc9a7.
//
...
// TokenByIndex is a free data retrieval call binding the contracts method 0x4f6ccce7.
//
...
// TokenOfOwnerByIndex is a free data retrieval call binding the contracts method 0x2f745c59.
//
...
// TokenURI is a free data retrieval call binding the contracts method 0xc87b56dd.
//
...
// Burn is a paid mutator transaction binding the contracts method 0x42966c68.
//
...
// MintWhitelist is a paid mutator transaction binding the contracts method 0xdd8e2103.
//
...
// SafeTransferFrom is a paid mutator transaction binding the contracts method 0x42842e0e.
//
...
// SafeTransferFrom0 is a paid mutator transaction binding the contracts method 0xb88d4fde.
//
...
// SetIsMinting is a paid mutator transaction binding the contracts method 0x7b93d1e5.
//
...
// SetMetadataUri is a paid mutator transaction binding the contracts method 0x1130630c.
//
...
// SetMintMaxTotal is a paid mutator transaction binding the contracts method 0x097fe575.
//
...
// SetMintOneCost is a paid mutator transaction binding the contracts method 0xef2148a3.
//
...
// SetRoot is a paid mutator transaction binding the contracts method 0xdab5f340.
//
...
// Withdraw is a paid mutator transaction binding the contracts method 0x3ccfd60b.
//
...
// ShoeSharkNftApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the ShoeSharkNft contracts.
type ShoeSharkNftApprovalIterator struct {
	Event *ShoeSharkNftApproval // Event containing the contracts specifics and raw log
...
// ShoeSharkNftApproval represents a Approval event raised by the ShoeSharkNft contracts.
...
// ShoeSharkNftApprovalForAllIterator is returned from FilterApprovalForAll and is used to iterate over the raw logs and unpacked data for ApprovalForAll events raised by the ShoeSharkNft contracts.
type ShoeSharkNftApprovalForAllIterator struct {
	Event *ShoeSharkNftApprovalForAll // Event containing the contracts specifics and raw log
...
// ShoeSharkNftApprovalForAll represents a ApprovalForAll event raised by the ShoeSharkNft contracts.
...
// ShoeSharkNftBatchMetadataUpdateIterator is returned from FilterBatchMetadataUpdate and is used to iterate over the raw logs and unpacked data for BatchMetadataUpdate events raised by the ShoeSharkNft contracts.
type ShoeSharkNftBatchMetadataUpdateIterator struct {
	Event *ShoeSharkNftBatchMetadataUpdate // Event containing the contracts specifics and raw log
...
// ShoeSharkNftBatchMetadataUpdate represents a BatchMetadataUpdate event raised by the ShoeSharkNft contracts.
...
// FilterBatchMetadataUpdate is a free log retrieval operation binding the contracts event 0x6bd5c950a8d8df17f772f5af37cb3655737899cbf903264b9795592da439661c.
//
...
// WatchBatchMetadataUpdate is a free log subscription operation binding the contracts event 0x6bd5c950a8d8df17f772f5af37cb3655737899cbf903264b9795592da439661c.
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
...
// ParseBatchMetadataUpdate is a log parse operation binding the contracts event 0x6bd5c950a8d8df17f772f5af37cb3655737899cbf903264b9795592da439661c.
//
// Solidity: event BatchMetadataUpdate(uint256 _fromTokenId, uint256 _toTokenId)
...
// ShoeSharkNftMetadataUpdateIterator is returned from FilterMetadataUpdate and is used to iterate over the raw logs and unpacked data for MetadataUpdate events raised by the ShoeSharkNft contracts.
type ShoeSharkNftMetadataUpdateIterator struct {
	Event *ShoeSharkNftMetadataUpdate // Event containing the contracts specifics and raw log
...
// ShoeSharkNftMetadataUpdate represents a MetadataUpdate event raised by the ShoeSharkNft contracts.
type ShoeSharkNftMetadataUpdate struct {
	TokenId *big.Int
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterMetadataUpdate is a free log retrieval operation binding the contracts event 0xf8e1a15aba9398e019f0b49df1a4fde98ee17ae345cb5f6b5e2c27f5033e8ce7.
//
...
// WatchMetadataUpdate is a free log subscription operation binding the contracts event 0xf8e1a15aba9398e019f0b49df1a4fde98ee17ae345cb5f6b5e2c27f5033e8ce7.
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
...
// ParseMetadataUpdate is a log parse operation binding the contracts event 0xf8e1a15aba9398e019f0b49df1a4fde98ee17ae345cb5f6b5e2c27f5033e8ce7.
//
// Solidity: event MetadataUpdate(uint256 _tokenId)
...
// ShoeSharkNftShoeSharkNftNftBurnedIterator is returned from FilterShoeSharkNftNftBurned and is used to iterate over the raw logs and unpacked data for ShoeSharkNftNftBurned events raised by the ShoeSharkNft contracts.
type ShoeSharkNftShoeSharkNftNftBurnedIterator struct {
	Event *ShoeSharkNftShoeSharkNftNftBurned // Event containing the contracts specifics and raw log
...
// ShoeSharkNftShoeSharkNftNftBurned represents a ShoeSharkNftNftBurned event raised by the ShoeSharkNft contracts.
...
// FilterShoeSharkNftNftBurned is a free log retrieval operation binding the contracts event 0xb781a8ff7579d9ce6007f40b74e6cc669642276819b1d6376e5c7d45bf8ae207.
//
...
// WatchShoeSharkNftNftBurned is a free log subscription operation binding the contracts event 0xb781a8ff7579d9ce6007f40b74e6cc669642276819b1d6376e5c7d45bf8ae207.
//
// Solidity: event ShoeSharkNft_NftBurned(address indexed player, uint256 indexed tokenId)
...
// ParseShoeSharkNftNftBurned is a log parse operation binding the contracts event 0xb781a8ff7579d9ce6007f40b74e6cc669642276819b1d6376e5c7d45bf8ae207.
//
// Solidity: event ShoeSharkNft_NftBurned(address indexed player, uint256 indexed tokenId)
...
// ShoeSharkNftShoeSharkNftNftMintedIterator is returned from FilterShoeSharkNftNftMinted and is used to iterate over the raw logs and unpacked data for ShoeSharkNftNftMinted events raised by the ShoeSharkNft contracts.
type ShoeSharkNftShoeSharkNftNftMintedIterator struct {
	Event *ShoeSharkNftShoeSharkNftNftMinted // Event containing the contracts specifics and raw log
...
// ShoeSharkNftShoeSharkNftNftMinted represents a ShoeSharkNftNftMinted event raised by the ShoeSharkNft contracts.
...
// FilterShoeSharkNftNftMinted is a free log retrieval operation binding the contracts event 0xb169f43911da2ad38176417bbe74935fc77da07aac5d00512351b11c9c0e69a0.
//
...
// WatchShoeSharkNftNftMinted is a free log subscription operation binding the contracts event 0xb169f43911da2ad38176417bbe74935fc77da07aac5d00512351b11c9c0e69a0.
//
// Solidity: event ShoeSharkNft_NftMinted(address indexed player, uint256 indexed tokenId)
...
// ParseShoeSharkNftNftMinted is a log parse operation binding the contracts event 0xb169f43911da2ad38176417bbe74935fc77da07aac5d00512351b11c9c0e69a0.
//
// Solidity: event ShoeSharkNft_NftMinted(address indexed player, uint256 indexed tokenId)
...
// ShoeSharkNftShoeSharkNftWithdrawIterator is returned from FilterShoeSharkNftWithdraw and is used to iterate over the raw logs and unpacked data for ShoeSharkNftWithdraw events raised by the ShoeSharkNft contracts.
type ShoeSharkNftShoeSharkNftWithdrawIterator struct {
	Event *ShoeSharkNftShoeSharkNftWithdraw // Event containing the contracts specifics and raw log
...
// ShoeSharkNftShoeSharkNftWithdraw represents a ShoeSharkNftWithdraw event raised by the ShoeSharkNft contracts.
type ShoeSharkNftShoeSharkNftWithdraw struct {
	Raw types.Log // Blockchain specific contextual infos
}

// FilterShoeSharkNftWithdraw is a free log retrieval operation binding the contracts event 0x52d1e090427e43f39f0a1936063f6d6f8619d7cb57685fd665f38d8ca12ba668.
//
...
// WatchShoeSharkNftWithdraw is a free log subscription operation binding the contracts event 0x52d1e090427e43f39f0a1936063f6d6f8619d7cb57685fd665f38d8ca12ba668.
//
// Solidity: event ShoeSharkNft_Withdraw()
...
// ParseShoeSharkNftWithdraw is a log parse operation binding the contracts event 0x52d1e090427e43f39f0a1936063f6d6f8619d7cb57685fd665f38d8ca12ba668.
//
// Solidity: event ShoeSharkNft_Withdraw()
...
// ShoeSharkNftTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the ShoeSharkNft contracts.
type ShoeSharkNftTransferIterator struct {
	Event *ShoeSharkNftTransfer // Event containing the contracts specifics and raw log
...
// ShoeSharkNftTransfer represents a Transfer event raised by the ShoeSharkNft contracts.
